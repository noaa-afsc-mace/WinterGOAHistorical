...
get_historical_biomass_data_winter  <- function(ship, survey, data_set_id, analysis_id) {




  biomass_nums_query <- paste0('SELECT a.ship, a.survey, a.data_set_id, a.analysis_id, a.report_number,  a.interval, a.length, a.transect, b.description, ',
                            ...
                            ' AND a.transect is not null AND b.report_number is not null ',
                              'AND a.species_code = 21740 ',
                               'GROUP BY a.ship, a.survey, a.data_set_id, a.analysis_id, a.report_number, a.interval, a.length, a.transect,  b.description ',
  ...
  biomass_nums_data = left_join(biomass_nums_data, intervals_data_h,
                                by = c('SHIP', 'SURVEY',  'INTERVAL', 'TRANSECT', 'REPORT_NUMBER'))

  biomass_nums_data = biomass_nums_data[!(biomass_nums_data$SURVEY == 200004 & biomass_nums_data$DESCRIPTION != "Shelikof Strait primary survey"),]
  biomass_nums_data = biomass_nums_data[!(biomass_nums_data$SURVEY == 199703 & biomass_nums_data$DESCRIPTION != "Pass 1"),]
  #biomass_nums_data = biomass_nums_data[!(biomass_nums_data$SURVEY == 200102 & biomass_nums_data$DESCRIPTION != "primary"),]
  ...
  #return(list(biomass_nums_data, intervals_data_h))
