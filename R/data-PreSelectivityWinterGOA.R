#' @title Pre-selectivity corrected dataset consisting of pollock biomass & numbers at length on a per-interval basis. Winter GOA.
#' @format A data frame with 1155222 rows and 16 columns:
#' \describe{
